...
excerpt: "Four plugins working. All four emit intents from real game state — `BuildIntent`, `TrainIntent`, `AttackIntent`, `MoveIntent`. But `SC2BotAgent.onStep()` drained the queue and logged every entry as `[…"
---
