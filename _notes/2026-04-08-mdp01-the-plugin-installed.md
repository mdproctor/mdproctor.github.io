---
layout: post
title: "Permuplate — The Plugin, Installed"
date: 2026-04-08
...
excerpt: "The plugin gap was clear from the previous session: IntelliJ knows nothing about Permuplate. Rename `Join2` and `className="Join${i}"` stays wrong. Click on `"Callable${i}"` and nothing happens. Edit…"
---
