...
![The enrichment pipeline — 6 operations on a single Jsoup Document](//assets/sparge/enrich-pipeline.png)
...
![Python requests vs Java HttpClient — side-by-side API comparison](//assets/sparge/http-comparison.png)
...
![Three-layer TDD for Phase 5 — unit, integration, E2E](//assets/sparge/tdd-pyramid.png)
