...
![Migration phases and architecture — JEP call count dropping phase by phase](//assets/sparge/migration-architecture.png)
...
![Python cfg dict vs Java ResolvedConfig record — side-by-side comparison](//assets/sparge/config-comparison.png)
