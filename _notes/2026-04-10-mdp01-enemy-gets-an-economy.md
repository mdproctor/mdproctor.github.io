...
excerpt: "E3 left us with a working combat loop: units fight, shields absorb, units die. The enemy Zealots still marched from spawn to nexus on a script — at frame 200, regardless of what the player bot was doi…"
---
...
![SC2 Marine — the enemy's combat output](/assets/quarkmind/sc2-marine.jpg)
...
![SC2 Command Center — the enemy's starting building](/assets/quarkmind/sc2-command-center.jpg)
