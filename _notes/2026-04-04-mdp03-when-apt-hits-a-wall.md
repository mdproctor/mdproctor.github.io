...
excerpt: "Java's Annotation Processing Tool (APT) is powerful but has one hard constraint that doesn't show up in most documentation: it can create new source files, but it cannot modify existing ones."
---
