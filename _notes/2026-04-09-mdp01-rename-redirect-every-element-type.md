...
excerpt: "The previous entry noted that rename redirect worked for classes but not for methods or fields. Shift+F6 on `join3()` inside `Join3.java`: IntelliJ renames the generated method directly. Next build ov…"
---
