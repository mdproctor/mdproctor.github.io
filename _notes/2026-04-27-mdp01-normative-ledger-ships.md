...
blurb: "Extending the ledger to all nine speech-act types reframes Qhorus from audit middleware to normative governance infrastructure — and the trust scoring models in quarkus-ledger turn out to be composable with agent reputation via EigenTrust propagation."
---
