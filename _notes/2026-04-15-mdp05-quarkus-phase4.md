...
![16 HTML issue detectors — scan_html.py ported to ScanHtml.java](//assets/sparge/scan-issues.png)
...
![BeautifulSoup vs Jsoup — the API comparison](//assets/sparge/bs4-jsoup.png)
...
![Three-layer TDD for Phase 4 — unit, integration, E2E](//assets/sparge/tdd-pyramid.png)
