---
layout: post
title: "Permuplate — OOPath: Walking the Object Graph"
date: 2026-04-06
...
excerpt: "OOPath is XPath for Java object graphs. A `Library` fact traverses into `rooms()`, then each room into `books()`, filtering at each step. The result — a `Tuple3<Library, Room, Book>` — joins back into…"
---
