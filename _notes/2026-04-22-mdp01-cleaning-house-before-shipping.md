...
excerpt: "The previous session ended with a question I'd been avoiding: are we actually improving the project each iteration, or just adding complexity for its own sake? I looked at the data — batch 10's test c…"
---
