...
date: 2026-04-24
type: jexl-string-assistance
entry_type: note
subtype: diary
projects: [permuplate]
tags: [permuplate, drools, dsl, annotation-processor, java]
excerpt: "There's a moment in design work where you realise the name you've been using for something is technically correct but conceptually wrong — it describes when something happens rather than what it does.…"
---
