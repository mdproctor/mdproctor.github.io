...
excerpt: "Blog 007 explained the deferral: the First/Second split required G3's extends clause auto-expansion, and G3's expansion required `T+number` naming to detect siblings. Alpha naming — `A, B, C, D` — had…"
---
