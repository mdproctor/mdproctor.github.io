...
excerpt: "Rule engines have two fundamental constraint patterns beyond joining. A fact combination is valid ONLY IF some condition has no matches — "there is no account with a balance over £1000." Or ONLY IF so…"
---
