---
layout: post
title: "Phase 1.5: Making Joins Type-Safe"
date: 2026-04-06
...
excerpt: "Blog 007 ended honestly: the type system broke down after the first `.join()`. Every subsequent `.filter()` lambda received `Object`-typed parameters — `((Person) a).age() >= 18` instead of `a.age() >…"
---
