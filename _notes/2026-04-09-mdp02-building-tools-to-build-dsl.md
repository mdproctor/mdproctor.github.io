---
layout: post
title: "Permuplate — Building the Tools to Build the DSL"
date: 2026-04-09
type: the-intellij-plugin
entry_type: note
subtype: diary
projects: [permuplate]
tags: [permuplate, drools, dsl, annotation-processor, java]
excerpt: "droolsvol2 compiles. That's been the blocker since we identified the migration path a couple of days ago — ~14 files still referencing `drools-core` symbols that vol2 is removing. Someone finished the…"
---
