...
blurb: "M-of-N parallel WorkItems ships after rewriting LAYERING.md — the rule \"if it touches another WorkItem it's orchestration\" was already broken by cascade cancellation, so the real test is whether it imposes ordering or requires external context."
---
